...
internal class GenomeAssemblerImplTest {
    ...
    private fun setUp() {
        ...
        whenever(regionAssembler.assemble(any(), any(), any()))
                .thenAnswer {
                    ...
                    Region(role, "A", arrayOf(99.0), feature.gene, feature.chromosome, feature.start, feature.end)
                }
    }
     ...
     */
    private data class FeatureTestImpl(
    ...
    private companion object {
        ...
        val MOCK_FEATURES = (1..100 step 10).map {
            FeatureTestImpl(MOCK_GENE, MOCK_CHROM, it, it + 10)
        }
