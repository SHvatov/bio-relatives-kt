...
internal class NaiveRegionAssemblerTest {
    ...
    companion object {
        ...
        private const val TEST_GENOME_START = 0

        private const val TEST_GENOME_END = 11
        ...
        private const val TEST_READ_LENGTH_2 = 11

        private const val TEST_READ_LENGTH_3 = 11

        private const val TEST_READ_STRING_1 = "ahgcetat"

        private const val TEST_READ_STRING_2 = "fgctagctagc"

        private const val TEST_READ_STRING_3 = "factggcatac"

        private const val TEST_READ_START_1 = 0
        private const val TEST_READ_START_2 = 1
        private const val TEST_READ_START_3 = 1
        ...
        private const val CHECK_SEQUENCE = "a*gcttgcttac"
    }
    ...
    fun assemble() {
        ...
        Assert.assertEquals(CHECK_SEQUENCE, assembler.assemble(RoleAware.Role.FATHER, TEST_FEATURE, TEST_SAMRECORDS).sequence)
    }
}